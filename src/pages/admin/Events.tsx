...
const events = [
  { title: "CCS Week 2024", type: "Curricular", date: "Apr 15-19, 2024", location: "CCS Building", participants: 320, status: "upcoming" },
  { title: "Hackathon: Code for Change", type: "Extra-curricular", date: "Apr 5, 2024", location: "Computer Lab 1 & 2", participants: 60, status: "upcoming" },
  { title: "IT Career Talk", type: "Seminar", date: "Mar 25, 2024", location: "AVR", participants: 150, status: "completed" },
  { title: "Programming Contest", type: "Competition", date: "Mar 20, 2024", location: "Lab 1", participants: 30, status: "completed" },
];
  ...
  <div className="space-y-6 animate-fade-in">
    <div className="flex justify-between items-start">
      <div>
        ...
        <p className="text-muted-foreground text-sm">Approve events, monitor participation</p>
      </div>
