    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      ...
      <div className="relative w-full max-w-md animate-fade-in">
        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          <img src={ucLogo} alt="University of Cabuyao" className="w-16 h-16 object-contain" />
          ...
          <img src={ccsLogo} alt="CCS Logo" className="w-16 h-16 object-contain" />
        </div>

        <Card className="border-0 shadow-xl shadow-secondary/10">
